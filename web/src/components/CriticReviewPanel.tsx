        ...
        <div className="flex items-center gap-2">
          {!isPass && onToggleEditor && (
            <button
              ...
              className="flex items-center gap-2 text-xs font-medium px-3 py-1.5 rounded border border-border bg-background text-foreground hover:bg-muted transition-colors"
            >
              Edit IMPL
            </button>
          )}
