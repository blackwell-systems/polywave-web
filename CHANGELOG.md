...
All notable changes to the Polywave web app will be documented in this file.

| [0.125.0] | 2026-05-11 | Rebrand completion — `polywave.config.json` repo paths updated to match actual disk locations (`polywave-web`, `polywave-go`, `polywave`); `SAW:COMPLETE` marker renamed to `polywave:complete` in Go source and help text; Polywave state machine comment updated; active IMPL doc paths and prose updated; `docs/CONTEXT.md` cross-repo paths updated |
